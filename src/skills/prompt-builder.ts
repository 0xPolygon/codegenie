  ...
  return {
    ...
    buildComposerPrompt: ({ groupedFindingsJson, intent, coverage, followUpHintNotes }) => {
      ...
      return buildPrompt(10, [
        ...
        "Write each finalBody as GitHub-flavored Markdown. Wrap file paths, symbols, identifiers, and code fragments in backticks; use fenced code blocks for multi-line code excerpts; bold inline labels such as **Impact:** or **Suggested fix:** are allowed. Never leave code, paths, or shell commands unformatted as plain prose.",
