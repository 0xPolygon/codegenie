...
Additional language and domain lenses, including the planned Python and Solidity slices plus security, database, performance, and concurrency, may be added as bundled skills after v1.
