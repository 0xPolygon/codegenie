...
Additional language and domain lenses, including the planned Solidity slice plus security, database, performance, and concurrency, may be added as bundled skills after v1.
