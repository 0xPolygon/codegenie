...
5. Add `src/github/duplicate-detector.ts`:
   ...
   - exact fingerprint skip and ±5-line fuzzy skip over viewer-authored codeninja comments.
...
- `resolver.pr-mode-fetches-and-diffs-github-matched-revisions`: PR mode uses metadata OIDs, fetches missing commits into `refs/codeninja/pr/<n>/*`, computes `mergeBase..head`, and returns PR metadata.
...
- `duplicate-detector-exact-and-fuzzy`: fingerprint and ±5-line duplicate rules skip only codeninja-authored comments.
